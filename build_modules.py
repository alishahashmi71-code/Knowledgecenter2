...
# =========================================================================
def module_01():
    total = len(SUCCESS) + len(FEATURED) + len(VIDEOS)
...
<div class="aih-lp">
  <section class="aih-hero" aria-labelledby="aih-hero-title">
    <div class="aih-container">
      ...
      <div class="aih-hero-stats">
        <div class="aih-hero-stat">
          <div class="aih-stat-num">%d+</div>
          <div class="aih-stat-label">Articles, guides &amp; videos</div>
        </div>
        <div class="aih-hero-stat">
          <div class="aih-stat-num">%d</div>
          <div class="aih-stat-label">Featured suppliers</div>
        </div>
        <div class="aih-hero-stat">
          <div class="aih-stat-num">%d</div>
          <div class="aih-stat-label">Industries covered</div>
        </div>
      </div>
    </div>
  </section>
</div>
""" % (CONTACT_URL, total, len(SUPPLIERS), len(IND_ORDER))
...
<div class="aih-lp">
  <section class="aih-section aih-bg-white" id="aih-library" aria-labelledby="aih-library-h">
    <div class="aih-container-wide aih-container">
      <h2 id="aih-library-h" class="aih-shead" style="display:block;margin-bottom:0.5rem;">Knowledge library</h2>
      <p style="color:#616161;margin-bottom:2rem;max-width:60ch;">Browse expert articles and customer
        success stories from Applied&reg; suppliers. Filter by industry, supplier, or content type to
        find what fits your operation.</p>
